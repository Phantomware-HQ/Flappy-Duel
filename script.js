...
const GRAVITY    = isMobile ? 0.15 : 0.04;     // mobilde neredeyse 4 kat düşüş
const FLAP_FORCE = isMobile ? -7.0 : -2.5;     // mobilde çok güçlü zıplama
const MAX_VEL    = 7;
const PIPE_W     = 68;
const PIPE_GAP   = 188;
const PIPE_SPEED = isMobile ? 5.0 : 1.5;       // mobilde çok hızlı borular
const BIRD_R     = 15;
/* ── Durum ───────────────────────────────────────── */
let canvas, ctx;
let myBird, oppBird;
